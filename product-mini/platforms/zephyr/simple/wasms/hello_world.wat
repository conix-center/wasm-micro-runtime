(module $hello_world.wasm
  ...
  (type (;12;) (func (param f64 i32 i32 i32 i32) (result i32)))
  (type (;13;) (func (param i64 i32 i32 i32 i32 i32) (result i64)))
  ...
  (func $sbrk (type 2) (param i32) (result i32)
    ...
    local.get 1)
  (func $__retarget_lock_acquire_recursive (type 5) (param i32))
  (func $__retarget_lock_release_recursive (type 5) (param i32))
  ...
  (func $__malloc_sbrk_aligned (type 2) (param i32) (result i32)
    (local i32 i32 i32)
    i32.const -1
    local.set 1
    block  ;; label = @1
  ...
  (func $__ashlti3 (type 8) (param i32 i64 i64 i32)
    ...
    local.get 2
    i64.store offset=8)
  (func $__pow5Factor (type 9) (param i64) (result i32)
    (local i32)
    i32.const -1
    local.set 1
    loop  ;; label = @1
    ...
    local.get 1)
  (func $__double_computePow5 (type 10) (param i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $__double_computeInvPow5 (type 10) (param i32 i32)
    (local i32 i32 i32 i64 i64)
    global.get $__stack_pointer
    i32.const 64
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $__umul128 (type 11) (param i64 i64 i32) (result i64)
    (local i64 i64 i64)
    local.get 2
    local.get 1
    i64.const 4294967295
    ...
    i64.and
    i64.or)
  (func $__dtoa_engine (type 12) (param f64 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 9)
  (func $mulShiftAll64 (type 13) (param i64 i32 i32 i32 i32 i32) (result i64)
    local.get 3
    local.get 0
    i64.const 2
    i64.shl
    ...
    local.get 2
    call $mulShift64)
  (func $umulh (type 14) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $decimalLength17 (type 9) (param i64) (result i32)
    (local i32 i64)
    i32.const 1
    local.set 1
    i64.const 10
    ...
    local.get 1)
  (func $div10 (type 14) (param i64) (result i64)
    local.get 0
    call $umulh
    i64.const 3
    i64.shr_u)
  (func $mulShift64 (type 15) (param i64 i32 i32) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
  ...
  (func $vfprintf (type 4) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 4)
  (func $skip_to_arg (type 16) (param i32 i32 i32)
  ...
  (func $__ultoa_invert (type 17) (param i64 i32 i32) (result i32)
    (local i32 i64 i64)
    i32.const 922746880
    local.get 2
    i32.const 24
  ...
  (global (;2;) i32 (i32.const 67536))
  (global (;3;) i32 (i32.const 131072))
  (global (;4;) i32 (i32.const 1988))
