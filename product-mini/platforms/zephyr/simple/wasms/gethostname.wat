(module $gethostname.wasm
  (type (;0;) (func))
  (type (;1;) (func (param i32 i32) (result i32)))
  (type (;2;) (func (param i32) (result i32)))
  (type (;3;) (func (result i32)))
  (type (;4;) (func (param i32 i32 i32) (result i32)))
  (type (;5;) (func (param f64 i32 i32 i32) (result i32)))
  ...
  (type (;11;) (func (param f64 i32 i32 i32 i32) (result i32)))
  (type (;12;) (func (param i64 i32 i32 i32 i32 i32) (result i64)))
  ...
  (import "wazi" "SYS_zsock_gethostname" (func $zsock_gethostname (type 1)))
  ...
  (func $__wasm_init_memory (type 0)
    ...
    data.drop $.rodata
    data.drop $.data)
  (func $__wasm_memory_grow (type 2) (param i32) (result i32)
    local.get 0
    memory.grow)
  (func $__wasm_memory_size (type 3) (result i32)
    memory.size)
  (func $_start (type 0)
    i32.const 0
    i32.const 0
  ...
  (func $picolibc_putc (type 1) (param i32 i32) (result i32)
    ...
    local.get 10
    return)
  (func $__dtox_engine (type 5) (param f64 i32 i32 i32) (result i32)
    ...
    i32.store
    local.get 2)
  (func $__log10Pow2 (type 2) (param i32) (result i32)
    local.get 0
    i32.const 78913
    i32.mul
    i32.const 18
    i32.shr_u)
  (func $__log10Pow5 (type 2) (param i32) (result i32)
    local.get 0
    i32.const 732923
    i32.mul
    i32.const 20
    i32.shr_u)
  (func $__pow5bits (type 2) (param i32) (result i32)
    local.get 0
    i32.const 1217359
    i32.mul
    i32.const 19
  ...
  (func $__ashlti3 (type 7) (param i32 i64 i64 i32)
    ...
    local.get 2
    i64.store offset=8)
  (func $__pow5Factor (type 8) (param i64) (result i32)
    (local i32)
    i32.const -1
    local.set 1
    loop  ;; label = @1
    ...
    local.get 1)
  (func $__double_computePow5 (type 9) (param i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $__double_computeInvPow5 (type 9) (param i32 i32)
    (local i32 i32 i32 i64 i64)
    global.get $__stack_pointer
    i32.const 64
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $__umul128 (type 10) (param i64 i64 i32) (result i64)
    (local i64 i64 i64)
    local.get 2
    local.get 1
    i64.const 4294967295
    ...
    i64.and
    i64.or)
  (func $__dtoa_engine (type 11) (param f64 i32 i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 9)
  (func $mulShiftAll64 (type 12) (param i64 i32 i32 i32 i32 i32) (result i64)
    local.get 3
    local.get 0
    i64.const 2
    i64.shl
    ...
    local.get 2
    call $mulShift64)
  (func $umulh (type 13) (param i64) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $decimalLength17 (type 8) (param i64) (result i32)
    (local i32 i64)
    i32.const 1
    local.set 1
    i64.const 10
    ...
    local.get 1)
  (func $div10 (type 13) (param i64) (result i64)
    local.get 0
    call $umulh
    i64.const 3
    i64.shr_u)
  (func $mulShift64 (type 14) (param i64 i32 i32) (result i64)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
  ...
  (func $vfprintf (type 4) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 4)
  (func $skip_to_arg (type 15) (param i32 i32 i32)
  ...
  (func $__ultoa_invert (type 16) (param i64 i32 i32) (result i32)
    (local i32 i64 i64)
    i32.const 922746880
    local.get 2
    i32.const 24
